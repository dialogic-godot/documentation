...
Returns | Method 
--- | --- 
<span class="hljs-attribute">[int](https://docs.godotengine.org/en/latest/classes/class_int.html#class-int)</span> | [<span class="hljs-title">find_next_index</span>](#property-find_next_index) ( ) 
<span class="hljs-attribute">[int](https://docs.godotengine.org/en/latest/classes/class_int.html#class-int)</span> | [<span class="hljs-title">find_opening_index</span>](#property-find_opening_index) ( ) 
...
<a class="header" id="property-find_next_index" href="#property-find_next_index">**<span class="hljs-attribute">func</span> [<span class="hljs-title">find_next_index</span>](#property-find_next_index) ( )</a>  ⇒ <span class="hljs-attribute">[int](https://docs.godotengine.org/en/latest/classes/class_int.html#class-int)</span>** 
...
<a class="header" id="property-find_opening_index" href="#property-find_opening_index">**<span class="hljs-attribute">func</span> [<span class="hljs-title">find_opening_index</span>](#property-find_opening_index) ( )</a>  ⇒ <span class="hljs-attribute">[int](https://docs.godotengine.org/en/latest/classes/class_int.html#class-int)</span>** 
