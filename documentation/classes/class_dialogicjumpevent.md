...
<span class="hljs-attribute">void</span> | [<span class="hljs-title">get_label_suggestions</span>](#property-get_label_suggestions) ( `filter`: [String](https://docs.godotengine.org/en/latest/classes/class_string.html#class-string) = `""` ) 
...
<span class="hljs-attribute">void</span> | [<span class="hljs-title">get_timeline_suggestions</span>](#property-get_timeline_suggestions) ( `filter`: [String](https://docs.godotengine.org/en/latest/classes/class_string.html#class-string) = `""` ) 
...
<a class="header" id="property-get_label_suggestions" href="#property-get_label_suggestions">**<span class="hljs-attribute">void</span> [<span class="hljs-title">get_label_suggestions</span>](#property-get_label_suggestions) ( `filter`: [String](https://docs.godotengine.org/en/latest/classes/class_string.html#class-string) = `""` )** </a>
...
<a class="header" id="property-get_timeline_suggestions" href="#property-get_timeline_suggestions">**<span class="hljs-attribute">void</span> [<span class="hljs-title">get_timeline_suggestions</span>](#property-get_timeline_suggestions) ( `filter`: [String](https://docs.godotengine.org/en/latest/classes/class_string.html#class-string) = `""` )** </a>
